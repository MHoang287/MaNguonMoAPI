                        ...
                        <div class="card product-card h-100 border-0 shadow-sm" data-product-id="<?= $product->id ?>">
                            <div class="position-relative overflow-hidden">
                                <img src="<?= getProductImageUrl($product->image) ?>" 
                                     ...
                                     onerror="this.onerror=null; this.src='https://via.placeholder.com/300x250/f8f9fa/6c757d?text=No+Image';">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <?php if (SessionHelper::isAdmin()): ?>
                                        <div class="row g-2 mt-1">
                                            ...
                                            <div class="col-6">
                                                <button onclick="deleteProductWithAPI(<?= $product->id ?>)" 
...
/* Prevent image loading errors from showing */
.product-image {
